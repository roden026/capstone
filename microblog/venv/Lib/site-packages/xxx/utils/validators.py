...
def _field(data, field, required):
    if field:
        ...
        if required and field not in data:
            raise exceptions.ValidationError('{field} field miss'.format(field=field))
...
def bool_field(data, field=None, required=True):
    ...
    if not required:
        return None
    raise exceptions.ValidationError('{field} must be bool type'.format(field=field or data))
...
def int_field(data, field=None, required=True):
    ...
    try:
        ...
        raise exceptions.ValidationError('{field} must be int type'.format(field=field or data))
...
def float_field(data, field=None, required=True):
    ...
    try:
        ...
        raise exceptions.ValidationError('{field} must be float type'.format(field=field or data))
...
def list_field(data, field=None, required=True):
    ...
    if isinstance(field_data, str):
        try:
            ...
            raise exceptions.ValidationError('{field} must be list type'.format(field=field or data))
...
def dict_field(data, field=None, required=True):
    ...
    if isinstance(field_data, str):
        try:
            ...
            raise exceptions.ValidationError('{field} must be dict type'.format(field=field or data))
